...
for t in prove_text prove_doutrina prove_positions prove_ausencia_aspecto prove_fatos prove_indice prove_fonte_unica prove_retry prove_casa_unica prove_palavra audita_estado; do
