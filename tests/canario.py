...
CANARIOS = [
    ...
    ("gênero do sujeito: 'si mesma' em relatório masculino",
     lambda t: tv._detect_genero_do_sujeito(t, {"gender": "masculino"}),
     "a ferida tem saída pelo trabalho para si mesma"),
    ("regência: 'convergir' usado como transitivo",
     lambda t: tv._detect_convergir_transitivo(t),
     "A orientação prática que este mapa inteiro converge é simples."),
    ("IC sem tradução",
...
NEGATIVOS = [
    ...
    ("recurso retórico dela: 'o resultado costuma ser alguém que…' FICA",
     lambda t: tv._detect_person_instantiation(t, {"person": "segunda"}),
     "o resultado costuma ser alguém que aprendeu a ser competente"),
    ("'o que converge quando tudo é resumido' é intransitivo e correto",
     lambda t: tv._detect_convergir_transitivo(t),
     "o trabalho central, o que converge quando tudo o mais é resumido"),
    ("gênero CERTO do sujeito não acende",
     lambda t: tv._detect_genero_do_sujeito(t, {"gender": "masculino"}),
     "a ferida tem saída pelo trabalho para si mesmo"),
